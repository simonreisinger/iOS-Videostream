...
- (void) setupVideoContextWithWidth:(int)width height:(int)height {
    ...
    //c->time_base.den = 30; // TODO edited here
	//c->time_base.num = 1; // TODO edited here
    self.stream->time_base.den = 30;
    self.stream->time_base.num = 1;
...
- (void) setupAudioContextWithSampleRate:(int)sampleRate {
    ...
    self.stream->time_base.den = 44100;// edited May 2018
    self.stream->time_base.num = 1;// edited May 2018
